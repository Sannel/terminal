...
ColorScheme ColorScheme::Default()
{
    ...
    cs.background = QColor(0x1E, 0x1E, 0x1E);
    cs.foreground = QColor(0xCC, 0xCC, 0xCC);
    cs.cursor     = QColor(0xFF, 0xFF, 0xFF);
    cs.selectionBg= QColor(0x26, 0x4F, 0x78);
    cs.ansiColors = {{
        QColor(0x00, 0x00, 0x00), QColor(0x80, 0x00, 0x00),
        QColor(0x00, 0x80, 0x00), QColor(0x80, 0x80, 0x00),
        QColor(0x00, 0x00, 0x80), QColor(0x80, 0x00, 0x80),
        QColor(0x00, 0x80, 0x80), QColor(0xC0, 0xC0, 0xC0),
        QColor(0x80, 0x80, 0x80), QColor(0xFF, 0x00, 0x00),
