...
namespace LTerm
{
    LTerminalDispatch::LTerminalDispatch(TextBuffer& buffer) noexcept :
        _buffer(buffer)
    {
    }

    bool LTerminalDispatch::ActionExecute(const char32_t ch)
    {
    ...
    bool LTerminalDispatch::ActionExecuteFromEscape(const char32_t ch)
    {
        return ActionExecute(ch);
    }

    bool LTerminalDispatch::ActionPrint(const char32_t ch)
    {
        _buffer.PrintChar(ch);
        return true;
    }

    bool LTerminalDispatch::ActionPrintString(const std::u32string_view string)
    {
        _buffer.PrintString(string);
        return true;
    }

    bool LTerminalDispatch::ActionPassThroughString(const std::u32string_view string)
    {
        return ActionPrintString(string);
    }

    bool LTerminalDispatch::ActionEscDispatch(const VT::VTID id)
    {
    ...
    bool LTerminalDispatch::ActionVt52EscDispatch(const VT::VTID /*id*/,
                                                   const VT::VTParameters /*params*/)
    {
        return true; // VT52 sequences not needed for modern terminal emulation
    }

    bool LTerminalDispatch::ActionCsiDispatch(const VT::VTID id,
                                               const VT::VTParameters params)
    {
    ...
    LTerminalDispatch::StringHandler
    LTerminalDispatch::ActionDcsDispatch(const VT::VTID /*id*/,
                                          const VT::VTParameters /*params*/)
    {
    ...
    bool LTerminalDispatch::ActionOscDispatch(const size_t parameter,
    ...
    bool LTerminalDispatch::ActionSs3Dispatch(const char32_t /*ch*/,
                                               const VT::VTParameters /*params*/)
    {
        return true;
    }

    void LTerminalDispatch::_applySgr(const VT::VTParameters params)
    {
